...
```
adb push banana-server-17.9.1-android-arm64 /data/local/banana-server
adb shell chmod 755 /data/local/banana-server
adb shell /data/local/banana-server &
adb forward tcp:10067 tcp:10067
